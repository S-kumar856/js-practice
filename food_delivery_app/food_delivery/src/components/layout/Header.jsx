...
const Header = () => {
  return (
    <>
      <div className="fixed top-0 w-[100%] max-w-full z-1000 bg-[#FFFF]">

        <nav className="border-gray-200 px-10 py-5 ">
          <div className="container mx-auto flex flex-wrap items-center justify-between">
            <a href="#" className="flex">
              ...
              <span className="self-center text-3xl font-semibold whitespace-nowrap">FoodMawa</span>
            </a>
            ...
            <div className="hidden md:flex justify-between items-center w-full md:w-auto md:order-1" id="mobile-menu-3">
              <ul className="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
                ...
                <li>
                  <Link to={'/restaurant'} className="text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">Restaurant</Link>
                </li>
                <li>
                  <a href="#" className="text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">Menu</a>
                </li>
              </ul>
            </div>
          </div>
